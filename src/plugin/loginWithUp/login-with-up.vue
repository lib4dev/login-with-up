  ...
  <div class="login-with-up">
    ...
    <div>
      ...
      <div class="footer sub-main-w3-footer">
        <p>{{ copyright }}</p>
        <p>
          <a @click="gotoCopyRight">{{ copyrightcode }}</a>
        </p>
      </div>
    </div>
  </div>
...
.qx-code-ico .icon-duanxinyanzhengma {
  font-size: 21px;
  position: relative;
  top: 3px;
}
